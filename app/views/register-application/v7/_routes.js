...
router.post('/landowner-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v7/landowner-permission')
  } else {
    res.redirect('/register-application/v7/land-registry')
  }
})
...
router.post('/landowner-permission-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v7/not-eligible-landowner')
  } else {
    res.redirect('/register-application/v7/land-registry')
  }
})
...
router.post('/land-registry-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v7/land-ownership-certificate')
  } else {
    res.redirect('/register-application/v7/third-parties')
  }
})
...
router.post('/land-ownership-certificate-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v7/not-eligible-land-ownership')
  } else {
    res.redirect('/register-application/v7/third-parties')
  }
})
...
router.post('/landowner-permission-correct-answer-land-registry-yes', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v7/landowner-permission-upload')
  } else {
    res.redirect('/register-application/v7/land-registry-search')
  }
})
...
router.post('/landowner-permission-correct-answer-land-registry-no', function (req, res) {
  ...
  if (install == "no"){
    ...
    res.redirect('/register-application/v7/land-ownership-certificate-upload')
  }
})
...
router.post('/third-parties-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v7/not-eligible-third-parties')
  } else {
    res.redirect('/register-application/v7/legal-agreements')
  }
})
...
router.post('/legal-agreements-answer', function (req, res) {
  ...
  if (install == "none"){
    res.redirect('/register-application/v7/not-eligible-legal-agreements')
  } else {
    res.redirect('/register-application/v7/management-plan')
  }
})
...
router.post('/metric-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v7/not-eligible-metric')
  } else {
    res.redirect('/register-application/v7/eligible')
  }
})
...
router.post('/location-options-answer', function (req, res) {
  ...
  if (install == "location-rpa"){
    res.redirect('/register-application/v7/location-rpa-search')
  } else if (install == "location-import"){
    res.redirect('/register-application/v7/location-import')
...
router.post('/location-options-answer-land-registry', function (req, res) {
  ...
  if (install == "location-rpa"){
    ...
    res.redirect('/register-application/v7/location-draw-map')
  }
})
...
router.post('/location-rpa-bespoke-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v7/location-rpa-select')
  } else {
    res.redirect('/register-application/v7/location-rpa-draw-boundary')
  }
})
...
router.post('/location-confirm-answer', function (req, res) {
  ...
  if (install == "no-again"){
    res.redirect('/register-application/v7/location-land-registry-search-detailed')
  } else if (install == "no"){
    res.redirect('/register-application/v7/location-options')
  } else {
    res.redirect('/register-application/v7/task-list')
  }
})
...
router.post('/metric-baseline-correct-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v7/metric-baseline-upload')
  } else {
    res.redirect('/register-application/v7/task-list')
  }
})
...
router.post('/legal-agreement-conservation-correct-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v7/legal-agreement-conservation-upload')
  } else {
    res.redirect('/register-application/v7/legal-agreement-financial-upload')
  }
})
...
router.post('/legal-agreement-planning-obligation-correct-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v7/legal-agreement-planning-obligation-upload')
  } else {
    res.redirect('/register-application/v7/task-list')
  }
})
...
router.post('/management-plan-correct-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v7/management-plan-upload')
  } else {
    res.redirect('/register-application/v7/task-list')
  }
})
...
router.post('/payment-answer', function (req, res) {
  ...
  if (install == "bacs"){
    res.redirect('/register-application/v7/payment-bacs')
  } else {
    res.redirect('/register-application/v7/payment-card')
  }
})
...
router.post('/payment-bacs-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v7/payment-bacs-no')
  } else {
    res.redirect('/register-application/v7/payment-status')
  }
})
...
router.post('/new-application', function (req, res) {
  req.session.data = {}
  res.redirect('/register-application/v7/landowner')
})
...
router.post('/sign-in-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v7/applications')
  } else {
    res.redirect('/register-application/v7/task-list')
  }
})
