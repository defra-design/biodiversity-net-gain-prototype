...
router.post('/location-rpa-bespoke-answer', function (req, res) {
  ...
  if (install == "yes"){
    ...
    res.redirect('/register-application/v11/location-rpa-draw-boundary')
  }
})
...
router.post('/landowner-only-answer', function (req, res) {
  ...
  if (install == "Yes"){
    res.redirect('/register-application/v11/landowner-confirm')
  } else {
    res.redirect('/register-application/v11/landowner-name')
  }
})
...
router.post('/legal-agreement-answer', function (req, res) {
  ...
  if (install == "none"){
    res.redirect('/register-application/v11/legal-agreement-no')
  } else {
    res.redirect('/register-application/v11/legal-agreement-upload')
  }
})
...
router.post('/legal-agreement-correct-answer', function (req, res) {
  ...
  if (install == "no"){
    ...
    res.redirect('/register-application/v11/legal-agreement-parties')
  }
})
...
router.post('/management-plan-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v11/management-plan-date-start')
  } else {
    res.redirect('/register-application/v11/management-plan-no')
  }
})
...
router.post('/management-plan-works-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v11/management-plan-maintaining')
  } else {
    res.redirect('/register-application/v11/management-plan-works-name')
  }
})
...
router.post('/management-plan-maintaining-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v11/management-plan-monitoring')
  } else {
    res.redirect('/register-application/v11/management-plan-maintaining-name')
  }
})
...
router.post('/management-plan-monitoring-answer', function (req, res) {
  ...
  if (install == "yes"){
    ...
    res.redirect('/register-application/v11/management-plan-monitoring-name')
  }
})
...
router.post('/management-plan-correct-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v11/management-plan-upload')
  } else {
    res.redirect('/register-application/v11/management-plan-date-start')
  }
})
...
router.post('/payment-answer', function (req, res) {
  ...
  if (install == "bacs"){
    res.redirect('/register-application/v11/payment-bacs')
  } else {
    res.redirect('/register-application/v11/payment-card')
  }
})
...
router.post('/payment-bacs-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v11/payment-bacs-no')
  } else {
    res.redirect('/register-application/v11/payment-status')
  }
})
...
router.post('/sign-in-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v11/applications')
  } else {
    res.redirect('/register-application/v11/task-list')
  }
})
...
router.post('/landowner-certificate-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v11/landowner-certificate-no')
  } else {
    res.redirect('/register-application/v11/landowner-certificate-upload')
  }
})
...
router.post('/landowner-certificate-correct-answer-landowner', function (req, res) {
  ...
  if (install == "no"){
    ...
    res.redirect('/register-application/v11/landowner-only')
  }
})
...
router.post('/landowner-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v11/landowner-others')
  } else {
    res.redirect('/register-application/v11/landowner-name')
  }
})
...
router.post('/address-confirm-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v11/address-search')
  } else {
    res.redirect('/register-application/v11/task-list')
  }
})
...
router.post('/allocation-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v11/allocation-yes')
  } else {
    res.redirect('/register-application/v11/allocation-no')
  }
})
