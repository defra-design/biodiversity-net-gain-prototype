...
router.post('/eligibility-england-answer', function (req, res) {
  ...
  if (install == "Yes"){
    res.redirect('/register-application/v20/eligibility-landowner-consent')
  } else {
    res.redirect('/register-application/v20/eligibility-england-no')
  }
})
...
router.post('/location-options-answer', function (req, res) {
  ...
  if (install == "none"){
    res.redirect('/register-application/v20/location-no')
  } else if (install == "Document or image"){
    res.redirect('/register-application/v20/location-upload')
  } else {
    res.redirect('/register-application/v20/location-import')
  }
})
...
router.post('/location-rpa-bespoke-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v20/location-rpa-select')
  } else {
    res.redirect('/register-application/v20/location-rpa-draw-boundary')
  }
})
...
router.post('/location-confirm-answer', function (req, res) {
  ...
  if (install == "no-again"){
    ...
    res.redirect('/register-application/v20/task-list')
  }
})
...
router.post('/location-upload-confirm-answer', function (req, res) {
  ...
  if (install == "no-again"){
    ...
    res.redirect('/register-application/v20/location-grid-reference')
  }
})
...
router.post('/location-import-confirm-answer', function (req, res) {
  ...
  if (install == "no-again"){
    ...
    res.redirect('/register-application/v20/location-confirm')
  }
})
...
router.post('/landowner-only-answer', function (req, res) {
  ...
  if (install == "Yes"){
    res.redirect('/register-application/v20/landowner-confirm')
  } else {
    res.redirect('/register-application/v20/landowner-name')
  }
})
...
router.post('/metric-correct-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v20/metric-upload')
  } else {
    res.redirect('/register-application/v20/metric-data-baseline')
  }
})
...
router.post('/allocation-metric-correct-answer', function (req, res) {
  ...
  if (install == "no"){
    ...
    res.redirect('/register-application/v20/allocation-metric-development')
  }
})
...
router.post('/allocation-development-answer', function (req, res) {
  ...
  if (install == "no"){
    ...
    res.redirect('/register-application/v20/allocation-metric-habitat')
  }
})
...
router.post('/allocation-habitat-answer', function (req, res) {
  ...
  if (install == "no"){
    ...
    res.redirect('/register-application/v20/allocation-confirm')
  }
})
...
router.post('/legal-agreement-answer', function (req, res) {
  ...
  if (install == "none"){
    res.redirect('/register-application/v20/legal-agreement-no')
  } else {
...
router.post('/local-land-charge-correct-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v20/local-land-charge-upload')
  } else {
    res.redirect('/register-application/v20/task-list')
  }
})
...
router.post('/management-plan-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v20/management-plan-date-start')
  } else {
    res.redirect('/register-application/v20/management-plan-no')
  }
})
...
router.post('/management-plan-works-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v20/management-plan-maintaining')
  } else {
    res.redirect('/register-application/v20/management-plan-works-name')
  }
})
...
router.post('/management-plan-maintaining-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v20/management-plan-monitoring')
  } else {
    res.redirect('/register-application/v20/management-plan-maintaining-name')
  }
})
...
router.post('/management-plan-monitoring-answer', function (req, res) {
  ...
  if (install == "yes"){
    ...
    res.redirect('/register-application/v20/management-plan-monitoring-name')
  }
})
...
router.post('/management-plan-correct-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v20/management-plan-upload')
  } else {
    res.redirect('/register-application/v20/management-plan-date-end')
  }
})
...
router.post('/payment-answer', function (req, res) {
  ...
  if (install == "bacs"){
    res.redirect('/register-application/v20/confirmation')
  } else {
    res.redirect('/register-application/v20/payment-card')
  } 
})
...
router.post('/payment-bacs-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v20/payment-no')
  } else {
    res.redirect('/register-application/v20/confirmation')
  }
})
...
router.post('/payment-bacs-answer-allocation', function (req, res) {
  ...
  if (install == "no"){
    ...
    res.redirect('/register-application/v20/allocation-confirmation')
  }
})
...
router.post('/sign-in-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v20/applications')
  } else {
    res.redirect('/register-application/v20/task-list')
  }
})
...
router.post('/landowner-certificate-answer', function (req, res) {
  ...
  if (install == "no"){
    res.redirect('/register-application/v20/landowner-certificate-no')
  } else {
    res.redirect('/register-application/v20/landowner-certificate-upload')
  }
})
...
router.post('/landowner-certificate-correct-answer', function (req, res) {
  ...
  if (install == "no"){
    ...
    res.redirect('/register-application/v20/land-ownership-list')
...
router.post('/landowner-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v20/landowner-others')
  } else {
    res.redirect('/register-application/v20/landowner-name')
  }
})
...
router.post('/address-confirm-answer', function (req, res) {
  ...
  if (install == "yes"){
    res.redirect('/register-application/v20/address-search')
  } else {
    res.redirect('/register-application/v20/task-list')
  }
})
...
router.post('/landowner-consent-answer', function (req, res) {
  ...
  if (install == "Yes, is landowner or leaseholder"){
    ...
    res.redirect('/register-application/v20/landowner-permission-upload')
  }
})
...
router.post('/routing-register-answer', function (req, res) {
  ...
  if (install == "No"){
    res.redirect('/register-application/v20/routing-results')
  } else {
    res.redirect('/register-application/v20/routing-sold')
  }
})
...
router.post('/additional-email-more-answer', function (req, res) {
  ...
  if (install == "yes"){
    ...
    res.redirect('/register-application/v20/check-answers')
  }
})
...
router.post('/additional-email-more-answer-allocation', function (req, res) {
  ...
  if (install == "yes"){
    ...
    res.redirect('/register-application/v20/allocation-check-answers')
  }
})
